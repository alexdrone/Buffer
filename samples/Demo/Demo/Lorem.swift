...
class Lorem {
  ...
  static var sentence: String {
    ...
    return compose(
      { word }, count: numberOfWordsInSentence, middleSeparator: .Space, endSeparator: .Dot,
      decorator: capitalizeFirstLetterDecorator)
  }
  ...
  static var title: String {
    ...
    return compose(
      { word }, count: numberOfWordsInTitle, middleSeparator: .Space,
      decorator: capitalizeStringDecorator)
  }
  ...
  static var date: Date {
    ...
    let referenceDate = (currentCalendar as NSCalendar).date(
      byAdding: referenceDateComponents, to: currentDate, options: calendarOptions)!
  ...
  fileprivate static func compose(
    _ provider: () -> String,
    count: Int,
    middleSeparator: Separator,
    endSeparator: Separator = .None,
    decorator: ((String) -> String)? = nil
  ) -> String {
    var composedString = ""
  ...
  fileprivate static let domains
...
extension Array {
  var randomElement: Element { return self[Int.random(max: count - 1)] }
}
